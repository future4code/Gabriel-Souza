import { 
  ...
  IUpdateQuantityRepositoryData,
  IDeletePurchaseRepository,
  IProductOutputData
} from "../model/purchaseModel";

import { Database } from "../data/database/Database";

//* Pegar e filtrar compras.
...
//* Atualizar quantidade de produtos depois de comprado
export class UpdateQuantityRepository extends Database implements IUpdateQuantityRepository {
  async updateQuantity ( data: IUpdateQuantityRepositoryData ) {
